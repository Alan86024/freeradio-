...
- **សៀវភៅសំឡេង** — ស្វែងរក និងបញ្ជូន ឬទាញយកសៀវភៅពីប្រភពពីរ៖ [GETEM](https://getem.boun.edu.tr/) បណ្ណាល័យឌីជីថលរបស់សាកលវិទ្យាល័យ Boğaziçi សម្រាប់អ្នកមានបញ្ហាការមើលឃើញ និង [LibriVox](https://librivox.org/) គម្រោងសៀវភៅសំឡេងសាធារណៈដែលអានដោយអ្នកស្ម័គ្រចិត្ត (មិនត្រូវការគណនី) ដោយមានការបន្តស្វ័យប្រវត្តិឆ្លងកាត់ការងារពហុផ្នែក — សូមមើល [សៀវភៅសំឡេង (GETEM និង LibriVox)](#សៀវភៅសំឡេង-getem-និង-librivox)។
...
## សៀវភៅសំឡេង (GETEM និង LibriVox)

FreeRadio រួមមានកម្មវិធីចាក់សៀវភៅសំឡេងដែលស្វែងរក ចាក់ និងទាញយកសៀវភៅពីប្រភពពីរ៖
...
លទ្ធផលពីប្រភពទាំងពីរលេចឡើងជាមួយគ្នានៅក្នុងបញ្ជី **លទ្ធផលស្វែងរក** រួមមួយ និងបញ្ជី **បណ្ណាល័យ** រួមមួយ — មិនមានផ្ទាំង ឬបញ្ជីទម្លាក់ចុះដាច់ដោយឡែកដើម្បីប្តូររវាងពួកវាទេ។ ប្រភពរបស់សៀវភៅនីមួយៗ (GETEM ឬ LibriVox) ត្រូវបានបង្ហាញជាស្លាកនៅជាប់ចំណងជើងរបស់វា និងនៅក្នុងព័ត៌មានលម្អិតរបស់វា ដូច្នេះអ្នកតែងតែដឹងថាអ្នកកំពុងមើលមួយណា។ អ្នកអាចស្វែងរក មើលជាមុន បន្ថែម ចាក់ និងទាញយកសៀវភៅពីប្រភពណាមួយតាមរបៀបដូចគ្នា; ចាក់ការងារពហុផ្នែកជាមួយការបន្តស្វ័យប្រវត្តិឆ្លងកាត់ផ្នែក; និងទាញយកសៀវភៅសម្រាប់ការស្តាប់ក្រៅបណ្តាញ — ទាំងអស់អាចចូលប្រើបានទាំងស្រុង។

ប្រភពណាមួយអាចបិទបានពី **ម៉ឺនុយ NVDA → ចំណូលចិត្ត → ការកំណត់ → FreeRadio** ជាមួយបញ្ជីធីក **ប្រភពសៀវភៅសំឡេង** ប្រសិនបើអ្នកចង់ស្វែងរកតែមួយក្នុងចំណោមពួកវា។ ទាំងពីរត្រូវបានបើកតាមលំនាំដើម។

> **ចំណាំ៖** ការស្តាប់សៀវភៅពី GETEM ត្រូវការសមាជិកភាពឥតគិតថ្លៃក្នុង GETEM។ ការរុករកកាតាឡុក GETEM មិនត្រូវការគណនីទេ ប៉ុន្តែការដោះស្រាយ និងចាក់សំឡេងសៀវភៅ GETEM ត្រូវការ — សូមមើល [ការចូលប្រើ](#ការចូលប្រើ) ខាងក្រោម។ សៀវភៅ LibriVox មិនត្រូវការគណនីឡើយ។
...
1. **ស្វែងរក** — ប្រអប់អត្ថបទដើម្បីស្វែងរកកាតាឡុកដែលបានបើកទាំងពីរក្នុងពេលតែមួយ ជាមួយបញ្ជីលទ្ធផលដែលលេចឡើងនៅពេលការស្វែងរកត្រូវបានដំណើរការ។
...
LibriVox មិនត្រូវការជំហានចូលប្រើណាមួយទេ — លទ្ធផល និងសំឡេងរបស់វាអាចត្រូវបានស្វែងរក មើលជាមុន ចាក់ និងទាញយកភ្លាមៗ ដោយមិនចាំបាច់បញ្ចូលព័ត៌មានសម្គាល់ណាមួយ។
...
- **ចម្លង URL** — ចម្លង URL ទំព័រកាតាឡុករបស់សៀវភៅទៅ clipboard (ទំព័រកាតាឡុក GETEM សម្រាប់សៀវភៅ GETEM ឬទំព័រព័ត៌មានលម្អិត archive.org សម្រាប់សៀវភៅ LibriVox)។
...
ប្រភពនីមួយៗរក្សាឯកសារបណ្ណាល័យផ្ទាល់ខ្លួន ទោះបីជាពួកវាត្រូវបានបង្ហាញបញ្ចូលគ្នានៅក្នុងផ្ទាំងសៀវភៅសំឡេងក៏ដោយ។ បណ្ណាល័យ GETEM របស់អ្នក (សៀវភៅដែលបានបន្ថែម និងការវិវត្តស្តាប់របស់ពួកវា) ត្រូវបានផ្ទុកក្នុង `freeradio_getem_library.json` ហើយបណ្ណាល័យ LibriVox របស់អ្នកត្រូវបានផ្ទុកដោយឡែកក្នុង `freeradio_librivox_library.json` ទាំងពីរនៅក្នុងថតកំណត់រចនាសម្ព័ន្ធអ្នកប្រើ NVDA។ ព័ត៌មានសម្គាល់ GETEM ដែលបានអ៊ិនគ្រីបរបស់អ្នកត្រូវបានផ្ទុកដោយឡែកក្នុង `freeradio_getem_credentials.bin` នៅទីតាំងតែមួយ ហើយអាចត្រូវបានឌិគ្រីបតែដោយគណនីអ្នកប្រើ Windows ដូចគ្នាដែលបានរក្សាទុកពួកវាប៉ុណ្ណោះ។ LibriVox គ្មានឯកសារព័ត៌មានសម្គាល់ទេ ព្រោះវាមិនត្រូវការគណនី។
...
- **បន្ថែមថត…** — បើកកម្មវិធីជ្រើសរើសថត។ រាល់ឯកសារសំឡេងដែលរកឃើញនៅខាងក្នុងថតដែលបានជ្រើសរើស រួមទាំងនៅក្នុងថតរងរបស់វា ត្រូវបានចាត់ទុកជាមួយក្នុងចំណោម **បទ** របស់ថតនោះ។ ថតខ្លួនឯងជាធាតុតែមួយនៅក្នុងបញ្ជី Jukebox របស់អ្នក; ឯកសារនៅខាងក្នុងវាត្រូវបានរាយក្នុងបញ្ជីបទនៅពេលថតត្រូវបានជ្រើសរើស។
- **លុប** — លុបធាតុដែលបានជ្រើសរើសបច្ចុប្បន្នចេញពី Jukebox របស់អ្នក។ ការលុបធាតុថតមិនលុបឯកសារណាមួយចេញពីដ្រាយទេ; វាគ្រាន់តែបំភ្លេចថតប៉ុណ្ណោះ។
...
- **លុប (`Alt+M`)៖** លុបបទដែលបានជ្រើសរើសចេញពី `likedSongs.txt` និងធ្វើបច្ចុប្បន្នភាពបញ្ជី។ គ្រាប់ចុច `Delete` ក៏បង្កឱ្យប៊ូតុងនេះដំណើរការដែរ នៅពេលបញ្ជីមានការផ្តោត។
...
| ប្រភពសៀវភៅសំឡេង | បញ្ជីធីកដែលជ្រើសរើសប្រភពសៀវភៅសំឡេងណាមួយ (**GETEM**, **LibriVox**) ត្រូវបានស្វែងរក និងបង្ហាញក្នុងផ្ទាំងសៀវភៅសំឡេង។ ទាំងពីរបើកតាមលំនាំដើម។ ការដោះធីកប្រភពលាក់សៀវភៅរបស់វាពីលទ្ធផលស្វែងរកបញ្ចូលគ្នា និងបញ្ជីបណ្ណាល័យ ដោយមិនលុបអ្វីដែលអ្នកបានបន្ថែមពីវារួចហើយ — សូមមើល [សៀវភៅសំឡេង (GETEM និង LibriVox)](#សៀវភៅសំឡេង-getem-និង-librivox)។ |
| ឈ្មោះអ្នកប្រើ GETEM / ពាក្យសម្ងាត់ GETEM | ព័ត៌មានសម្គាល់សមាជិកភាពសៀវភៅសំឡេង [GETEM](https://getem.boun.edu.tr/) របស់អ្នក ដែលត្រូវការដើម្បីបញ្ជូន ឬទាញយកសំឡេងសៀវភៅ — សូមមើល [ការចូលប្រើ](#ការចូលប្រើ)។ ផ្ទុកអ៊ិនគ្រីបនៅលើដ្រាយតាមរយៈ Windows Data Protection API ភ្ជាប់នឹងគណនីអ្នកប្រើ Windows របស់អ្នក; មិនដែលផ្ទុកជាអត្ថបទធម្មតា។ ការទុកវាលទាំងពីរទទេ និងរក្សាទុកលុបព័ត៌មានសម្គាល់ដែលបានរក្សាទុកណាមួយ។ LibriVox មិនត្រូវការគណនី និងគ្មានវាលសមមូលទេ។ |
